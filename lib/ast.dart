...
class Configure extends Node {
  ...
  @override
  String toString() {
    return '(Configure name:$name location:$location) fields:$fields';
  }
}
...
class NamedType extends Node {
  ...
  NamedType({required this.name, required this.type, this.value, this.offset});
  ...
  @override
  String toString() {
    return '(NamedType name:$name type:$type value:$value)';
  }
}
